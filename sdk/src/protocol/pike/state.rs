...
mod tests {
    ...
    #[test]
    // check that an Agent is built correctly
    ...
    #[test]
    // check that an Agent can be converted to bytes and back
    ...
    #[test]
    // check that an AgentList is built correctly
    ...
    #[test]
    // check that an AgentList can be converted to bytes and back
